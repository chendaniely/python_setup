...
The [Posit](https://posit.co/) [Solutions Engineering Team](https://solutions.posit.co/) recommends using `pyenv` to manage your different Python versions. You can find their guide here:
...
We recommend that you try to keep your base python version as clean as possible, i.e., do not install any packages into it. Instead, please head over to the [Virtual Environments page](020-python_virtual_environments.qmd) and install your packages into a virtual environment.