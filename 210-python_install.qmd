...
recommends using `pyenv` to manage your different Python verisons.
You can find their guide here:

[https://solutions.posit.co/write-code/minimum-viable-python/installing-python/](https://solutions.posit.co/write-code/minimum-viable-python/installing-python/)
...
Instead, please head over to the Virtual Environments page
and install your packages into a virtual environment.
