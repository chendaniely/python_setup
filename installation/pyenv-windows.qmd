...
3. Using a windows package manager (e.g., chocolately, scoop)
...
You need to add a few variables into your Enviornment Variables.
You can do this by pressing the windows key and searching for the "Edit enviornment bariables for your account".
